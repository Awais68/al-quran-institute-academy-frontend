        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-12">
          <div>
            ...
            <p className="mb-3 sm:mb-4 md:mb-6 text-primary-200 leading-relaxed text-xs sm:text-sm">
              Providing quality Islamic education with a focus on character development and practical implementation of
              knowledge.
            </p>
          ...
          <div>
            <h4 className="text-sm sm:text-base md:text-lg font-bold mb-3 sm:mb-4 md:mb-6 text-white">Quick Links</h4>
          ...
          <div className="xs:col-span-2 lg:col-span-1">
            <h4 className="text-sm sm:text-base md:text-lg font-bold mb-3 sm:mb-4 md:mb-6 text-white">Programs</h4>
            <ul className="space-y-1.5 sm:space-y-2 md:space-y-3">
              <li>
                <Link
                  href="/#programs"
                ...
                >
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-accent-500 rounded-full mr-1.5 sm:mr-2"></span>
                  <span className="font-noto ml-1">حفظ القرآن</span> - Hifz-ul-Quran
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-accent-500 rounded-full mr-1.5 sm:mr-2"></span>
                  <span className="font-noto ml-1">تجوید</span> - Tajweed
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-accent-500 rounded-full mr-1.5 sm:mr-2"></span>
                  <span className="font-noto ml-1">اسلامی تعلیمات</span> - Islamic Studies
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-accent-500 rounded-full mr-1.5 sm:mr-2"></span>
                  <span className="font-noto ml-1">عربی زبان</span> - Arabic Language
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <span className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-accent-500 rounded-full mr-1.5 sm:mr-2"></span>
                  <span className="font-noto ml-1">فقہ</span> - Fiqh
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="xs:col-span-2 lg:col-span-1">
            <h4 className="text-sm sm:text-base md:text-lg font-bold mb-3 sm:mb-4 md:mb-6 text-white">Contact Info</h4>
            <ul className="space-y-2 sm:space-y-3 md:space-y-4">
              <li className="flex items-start">
                <MapPin className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 mr-2 md:mr-3 text-accent-400 mt-0.5 flex-shrink-0" />
