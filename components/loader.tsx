...
type SpinnerProps = {
  size?: "xs" | "sm" | "md" | "lg"; // control width/height
  color?: string; // Tailwind fill color, like "fill-blue-600"
};
...
const Spinner: React.FC<SpinnerProps> = ({
  ...
  return (
    <div
      role="status"
      className="min-h-screen flex justify-center items-center content-center bg-blue-50 "
    >
      <svg
        aria-hidden="true"
        className={`inline ${sizeMap[size]} text-gray-200 animate-spin dark:text-gray-600 ${color}`}
        viewBox="0 0 100 101"
        fill="none"
