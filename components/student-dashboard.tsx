                        ...
                        <div className="space-y-4">
                          <div className="p-4 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-blue-700 text-sm">
                              ...
                              pronunciation. Keep practicing the Ikhfa rule with
                              the letters we discussed."
                            </p>
                          </div>
                          ...
                          <div className="p-4 bg-green-50 rounded-lg">
                            ...
                            <p className="text-blue-700 text-sm">
                              "Great work on the Makharij exercises. Your
                              articulation points are much clearer now. Ready
                              for the next level!"
                            </p>
                          </div>
                        </div>
